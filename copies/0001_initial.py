...
from social_django.storage import (DjangoAssociationMixin, DjangoCodeMixin,
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("user", models.ForeignKey(related_name="social_auth", to=USER_MODEL, on_delete=models.CASCADE)),
            ],
            options={
